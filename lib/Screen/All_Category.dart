...
List<Product>? subListProduct;
                        ...
                        builder: (context, data, child) {
                          return data.isNotEmpty
                              ? GridView.count(
                                  ...
                                  crossAxisCount: 3,
                                  shrinkWrap: true,
                                  childAspectRatio:isHide==true? .2:.6,
  ...
  subCatItem(List<Product> subList, int index, BuildContext context) {
      ...
      child: Column(
        children: <Widget>[
         ...
         isHide==true? Row(
          ...
          isHide==true?
          subCatItemCate(index,context,subList,subList[index].name)
         :SizedBox()
        ],
      ),
      onTap: () {
        if (context.read<CategoryProvider>().curCat == 0 &&
          ...
          setState(() {
              subListProduct=subList;
              isHide=!isHide;
            });
            print("isssss"+isHide.toString());
          // GridView.count(
          ...
          //   subList.length,
          //   (index) {
          //     return subCatItemCate(index, context, subList[index].subList, subList[index].name!.toUpperCase() );
          //   },
          // ));
          // Navigator.push(
          //     context,
   ...
   subCatItemCate(int index2, BuildContext context, List<Product>? subList, String?title ,{String? maxDis,
   String? minDis}) {
                  ...
                  child: Column(
                    ...
                    CircleAvatar(
                        ...
                        child: ClipRRect(
                            ...
                            child: 
                            networkImageCommon(
                                subList[index2].subList![index].image??"", 100, false))
                        /*CachedNetworkImage(
                        imageUrl: subList[index].image!,
                        fadeInDuration: const Duration(milliseconds: 150),
                        fit: BoxFit.fill,
